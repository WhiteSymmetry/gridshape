...
To report a bug, first make sure there isn't already an open [GitHub Issue](https://github.com/WhiteSymmetry/gridshape/issues)
...
Look through the [GitHub Issues](https://github.com/WhiteSymmetry/gridshape/issues) for any
...
2. Create your own fork of the Solar Data Tools [repository](https://github.com/WhiteSymmetry/gridshape).
3. Clone your repository, for example by typing in your terminal:
`git clone https://github.com/<your_username>/gridshape.git`.
4. Install `gridshape` as editable in your new environment:
